...
const properties = Object.keys(openingHours); // It's an array with property names of openingHours.
for (const day of Object.keys(openingHours)) {
  //   console.log(day);
}

// WHAT IF WE WANT PROPERTY VALUES ITSELF
const values = Object.values(openingHours);

// console.log(values);

//ENTIRE OBJECTS:
const entriesArr = Object.entries(openingHours);
...
/*
1. Below is the entries variable that stores an empty array. Use the for-of loop together with the Object.keys() method to loop over the thirdParty.goodreads property (array) of the first book object from the books array. For each key, push a new array that contains that key to the entries array.
...
// let object = Object.entries(books);
// console.log(object);
let targetObj = books[0].thirdParty.goodreads;
...
*/
for (const [index, value] of Object.values(targetObj).entries()) {
